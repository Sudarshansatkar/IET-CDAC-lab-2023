...
///Validate Emp
    ...
    public static bool ValidateEmp(Employee e)
    {
     ...
     //Validate username for password change

     public static bool ValidatePass(Employee e)
    {
        bool status=false;
        MySqlConnection con=new MySqlConnection();
        con.ConnectionString=conString;
        string query="Select * from empdnetreg where username=('"+e.username+"')";
...
public static bool UpdatePass(Employee emp)        
    {
        bool status = false;
        MySqlConnection con = new MySqlConnection();
        con.ConnectionString = conString;
        string query = "update empdnetreg set password='"+emp.Password+"' where username=('"+emp.username+"')";
        try
        {
