...
public class HeapSort {
	...
	public static void main(String[] args) {
		int[] arr = { 65, 35, 26, 13, 23, 12, 91, 51, 20, 75, 19 };
		...
		System.out.println("No. of passes:" + (arr.length - 1));
	}
	...
	private static void heapify(int[] arr, int n, int i) {
		...
		if (largest != i) {
			...
			arr[largest] = arr[i];
			arr[i] = temp;
			heapify(arr, n, largest); // to check largest node has child or not then again heapify
		}
