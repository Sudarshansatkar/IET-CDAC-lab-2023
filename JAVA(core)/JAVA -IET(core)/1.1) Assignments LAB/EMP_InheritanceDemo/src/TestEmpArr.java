...
public class TestEmpArr {
	...
	public static void main(String[] args) {
		...
		case 4:
			...
			int id=sc.nextInt();
			int pos=EmployeeService.searchById(id);
			boolean St1=EmployeeService.displaybyID(pos);
			
			if(St1) 
			{
				System.out.println("Displayed BY ID");
			}
			else 
			{
				System.out.println("id not found");
		...
		case 6:{
			...
			pid=sc.nextInt();
			double bonus=EmployeeService.calculateBonusById(pid);
			  if(bonus==-2)
			  {
			    	 System.out.println("Not Salaried Emp.");
			    }
			     else if(bonus==-3)
			    	 {
			    	 System.out.println("id not found");
