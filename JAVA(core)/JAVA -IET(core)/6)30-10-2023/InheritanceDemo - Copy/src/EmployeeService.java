...
public class EmployeeService {
	...
	static {
		...
		emparr[4]=new Vendor(16,"wini","888","wini@gmail.com","JS","Executive",LocalDate.of(2015,02,15),1000,20000);
		cnt=5;
	}
	...
	public static void addnewEmployee(int ch) {
		...
		case 3:
			...
			int no_ofEmp=sc.nextInt();
			System.out.println("Enter the amount:");
			double amount=sc.nextDouble();
			
			emparr[cnt]=new Vendor(pid,nm,mob,em,dept,desg,ldt, no_ofEmp,amount);
			break;
		}
		cnt++;
	...
	public static double calculateBonusById(int pid)
	{
		...
		//	System.out.println("Not salaried employee so ");
			return -2;
		}
		return -3;
	...
	public static boolean displaybyID(int pos1)
	{
		if(pos1!=-1)
		{
		System.out.println(emparr[pos1]);
		}
		else
		{
		return false;
